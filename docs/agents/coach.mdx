...
<img src="/images/coach-panel.png" alt="Coach panel suggesting changes to an agent" style={{borderRadius: "12px", marginBottom: "24px"}} />
...
The file is **session-only** — it's not stored. If Coach decides the content should be a permanent knowledge source, it will propose adding it to the Knowledge Base for you to apply.
